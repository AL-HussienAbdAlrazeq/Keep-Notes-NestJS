...
const check_email_exist_middleware_1 = require("../../Core/middleware/check-email-exist.middleware");
let AuthModule = class AuthModule {
    configure(consumer) {
        consumer.apply(check_email_exist_middleware_1.CheckEmailExistMiddleware).exclude().forRoutes(signup_controller_1.SignupController);
    }
};

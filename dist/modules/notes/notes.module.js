...
exports.NotesModule = NotesModule = __decorate([
    (0, common_1.Module)({
        imports: [
            mongoose_1.MongooseModule.forFeature([{ name: notes_schema_1.Notes.name, schema: notes_schema_1.NotesSchema }]),
        ],
        providers: [notes_service_1.NotesService, jwt_1.JwtService],
